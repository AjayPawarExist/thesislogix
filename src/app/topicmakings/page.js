  ...
  return (
    ...
    <div className="flex flex-col items-center">
            ...
            <div className="w-full bg-gradient-to-b from-blue-950 to-gray-600 text-center py-20">
              <h1 className="text-4xl lg:text-5xl font-semibold text-white">TOPIC MAKING SERVICE</h1>
            ...
            <div className='w-full flex justify-center pt-5'>
              <Image src="/topicmakings.jpg" alt="error" width={400} height={100} className='w-[70%] h-[400px]'/>
            </div>
