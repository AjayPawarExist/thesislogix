...
export default function Paperpublication() {
  return (
    <>
      ...
      <div className="px-6 sm:px-10 lg:px-24 py-6 text-justify">
        ...
        <div className="bg-gray-100 shadow-lg shadow-blue-200 rounded-lg mt-8 p-4 sm:p-8 md:p-12">
          ...
          <ul className="py-4">
            <li className="py-2">
              <b>Curating Target Journals for Your Field of Study</b> : Drawing
            ...
            <li className="py-2">
              <b>Navigating Journal Guidelines</b> : Our meticulous team delves
            ...
            <li className="py-2">
              {" "}
              <b>Timely Submission </b>: Our seasoned experts, attuned to the
            ...
            <li className="py-2">
              {" "}
              <b>Impressive Cover Letters and Abstracts </b>: Our skilled
            ...
            <li className="py-2">
              {" "}
              <b>Revisions </b>: The journey toward publication is not always
