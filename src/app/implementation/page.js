  ...
  return (
    <>
      ...
      <div className="px-6 sm:px-10 lg:px-24 py-6">
        <div className="bg-gray-100 shadow-lg shadow-blue-200 rounded-lg mt-8 p-6 sm:p-8 md:p-12">
          ...
          <p className="text-gray-700 leading-relaxed ">
            ...
            getting the customer live with the product and in turn achieving the
            initial value milestone. The type of product and the associated
            complexity dictates the type of team, timeline and implementation
            methodology needed.
          </p>
          ...
          <p className="text-gray-700 leading-relaxed mt-2">
            ...
            solution grows or with acquisition of enterprise customers often
            sees vendors needing to develop a more professional approach to
            project management underpinned by a PMO.
          </p>
        </div>
      </div>
      <h1 className="text-2xl text-center py-5 text-black">
      ...
      <div className="max-w-[1320px] mx-auto grid lg:grid-cols-2 md:grid-col-2 gap-12  px-4">
        <div className="bg-slate-100 border-blue-400 border-2 shadow-lg hover:scale-105 rounded-md p-6">
          <div className="flex items-center justify-center h-24">
            <SiPlangrid className="h-16 w-16 text-blue-500" />
          </div>
          ...
          <p className="text-gray-500 text-center pb-4 px-2">
            ...
            requirements alongside skills and roles needs to inform hiring
            decisions.
          </p>
        </div>
        <div className="bg-slate-100 border-2 border-blue-400 shadow-lg hover:scale-105 rounded-md p-6">
          <div className="flex items-center justify-center h-24">
            <AiOutlineAppstoreAdd className="h-16 w-16 text-blue-500" />
          </div>
          <h1 className="text-black text-3xl font-bold text-center pt-4 py-4">
            SALES ALIGNMENT
          </h1>
          <p className="text-gray-500 text-center px-2">
            ...
            and that PS is brought in at the right time to scope projects.
          </p>
        </div>

        <div className="bg-slate-100 border-2 border-blue-400 shadow-lg hover:scale-105 rounded-md p-6">
          <div className="flex items-center justify-center h-24">
            <BiCool className="h-16 w-16 text-blue-500" />
          </div>
          ...
          <p className="text-gray-500 text-center px-4">
            ...
            side. Curate project information, customer tasks and dependencies
            effectively so that the customer knows what they need to do and
            when, to plan ahead.
          </p>
        </div>
        ...
        <div className="bg-slate-100 border-2 border-blue-400 shadow-lg hover:scale-105 rounded-md p-6">
          <div className="flex items-center justify-center h-24">
            <FaPersonDrowning className="h-16 w-16 text-blue-500" />
          </div>
          <h1 className="text-black text-3xl font-bold text-center py-4">
            CONTROL OVERRUN
          </h1>
          <p className="text-gray-500 text-center px-4">
            ...
            to creep to please the customer. Foster a culture where the team
            take a prescriptive approach and coaches the customer through the
            implementation processes quickly and effectively.
          </p>
        </div>
      </div>
      ...
      <div className="px-6 sm:px-10 lg:px-24 py-6">
        <div className="bg-gray-100 shadow-lg shadow-blue-200 rounded-lg mt-8 p-6 sm:p-8 md:p-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            velocity of implementations have an outsized impact on the customer
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            corresponding impact on revenue generation, customer retention,
        ...
        <div className="bg-gray-100 shadow-lg shadow-blue-200 rounded-lg mt-8 p-6 sm:p-8 md:p-12 ">
          ...
          <p className="text-gray-700">
            ...
            software licences are provisioned at go-live - for one publicly
            traded telecoms company, one of their business units booked $100m in
            ARR but only recognized $40m within the financial year due to delays
            in delivery.
          </p>
          ...
          <p className="text-gray-700">
            ...
            of services delivery including resourcing, project management,
            customer collaboration and financial management. Project plans
            including resource requirements are created based on the
            Professional Services package sold in Salesforce. Your onboarding
            playbooks are mapped to customer segments, products, or your own
            criteria all within Salesforce.
          </p>
        </div>
      </div>
    </>
