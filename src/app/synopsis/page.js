  ...
  return (
    ...
    <div className="px-4 sm:px-12 md:px-24 py-6">
      <div className="h-auto w-full  bg-gray-100 shadow-lg shadow-blue-200 px-6 md:px-10 rounded-lg py-6">
        <p className="py-6">
          A synopsis is a brief summary of the major points of the subject. Our expert will ensure
        ...
        <p className="py-4">
          *Synopsis Writing Services*: For a better “Research Thesis”, having a solid Synopsis is
          ...
          that you have done good research on your topic. It guides you all through your PhD programme.
