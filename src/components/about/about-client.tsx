...
export default function AboutClient() {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description:
        "Started offering support for PhD thesis development, Scopus and SCI journal publications, gaining traction among scholars.",
    },
    {
      year: "2017",
      title: "Research Partnerships",
      description:
        "Collaborated with experienced academicians and editors to broaden service quality and domain expertise.",
    },
    {
      year: "2019",
      title: "Digital Transformation",
      description:
        "Adopted advanced research tools, plagiarism detection systems, and project management platforms to streamline service delivery.",
    },
    {
      year: "2021",
      title: "Global Outreach",
      description:
        "Expanded our presence by serving clients across multiple countries and publishing in top-tier international journals.",
    },
    {
      year: "2023",
      title: "Recognized Excellence",
      description:
        "Acknowledged by researchers from top Indian institutions like IITs, IIMs, and Central Universities for high-quality editorial and publication support.",
    },
    {
      year: "2024",
      title: "Continued Commitment",
      description:
        "Actively working with diverse Scopus, SCI, and Web of Science journals to support scholars worldwide.",
    },
  ]
            ...
            >
              ...
              <div className="space-y-6 text-slate-600">
                ...
                <p className="text-lg">
                  ...
                  Whether it&apos;s selecting the right research topic, drafting a flawless thesis, or perfecting your
                  work through meticulous proofreading and editing, ThesisLogix ensures that every detail is handled
                  with precision.
                </p>

                <p className="text-lg">
                  Our services go beyond just delivering a document—we work to enhance your research skills and
                  understanding, ensuring that you stand out among your peers. We believe that every scholar&apos;s
                  research journey is unique, and that&apos;s why we offer personalized solutions tailored to your
